...
# Toolchain file: Windows arm64 target with MSVC.
#
...
# target (vcvarsall arm64 on an ARM64 host, or vcvarsall x64_arm64 on an x64 host).
#
...
if(CMAKE_GENERATOR MATCHES "Visual Studio")
    ...
    if(CMAKE_GENERATOR_PLATFORM)
        ...
        if(NOT _rtxns_platform STREQUAL "arm64")
            message(FATAL_ERROR
                "This toolchain file targets ARM64, but the generator platform is '${CMAKE_GENERATOR_PLATFORM}'. "
    ...
    set(CMAKE_GENERATOR_PLATFORM ARM64 CACHE INTERNAL "Generator platform (initialized by the toolchain file)")
elseif(NOT _rtxns_toolchain_env_checked)
    ...
    if(DEFINED ENV{VSCMD_ARG_TGT_ARCH})
        ...
        if(NOT _rtxns_env_target STREQUAL "arm64")
            message(FATAL_ERROR
                "This toolchain file targets ARM64, but the Visual Studio developer environment targets "
                "'$ENV{VSCMD_ARG_TGT_ARCH}'. Configure from the Developer Command Prompt for ARM64 "
                "(vcvarsall arm64 on an ARM64 host, or vcvarsall x64_arm64 on an x64 host), or pick the preset that matches this environment.")
        endif()
    elseif(NOT CMAKE_CXX_COMPILER AND NOT DEFINED ENV{CXX})
        message(WARNING
            ...
            "Developer Command Prompt for ARM64 (vcvarsall arm64 on an ARM64 host, or vcvarsall x64_arm64 on an x64 host), or open the folder in Visual Studio or "
            "VS Code, which set it up from the preset.")
    endif()
endif()

set(RTXNS_TARGET_ARCH "arm64" CACHE STRING "Target CPU architecture (set by the toolchain file)" FORCE)
